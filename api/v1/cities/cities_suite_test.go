...
// DoPatch makes http.Patch req
func (c *Client) DoPatch(url string, body interface{}) (*http.Response, error) {
	b, err := json.Marshal(body)
	if err != nil {
		return nil, err
	}

	return c.Do(http.MethodPatch, c.URL+c.Version+url, bytes.NewReader(b))
}
...
func (c *Client) GetCities() (*http.Response, error) {
	return c.DoGet("/cities")
}
...
func (c *Client) GetCitiesByID(id int) (*http.Response, error) {
	return c.DoGet(fmt.Sprintf("/cities/%d", id))
}

func (c *Client) UpdateCities(id int, req *schema.CityReq) (*http.Response, error) {
	return c.DoPatch(fmt.Sprintf("/cities/%d", id), req)
}

func (c *Client) DeleteCity(id int) (*http.Response, error) {
	return c.DoDelete(fmt.Sprintf("/cities/%d", id))
}

func (c *Client) GetCityWebhookByID(id int) (*http.Response, error) {
	return c.DoGet(fmt.Sprintf("/cities/%d/webhooks", id))
}

func (c *Client) GetCityTemperatureByID(id int) (*http.Response, error) {
	return c.DoGet(fmt.Sprintf("/cities/%d/temperature", id))
}
